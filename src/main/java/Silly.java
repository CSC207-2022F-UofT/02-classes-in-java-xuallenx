...
public class Silly implements Comparable<Silly>{
     ...
     *
     * Creates a new silly object.
     * This constructor takes in two strings and concatenates the two
     *
     * @param stringone a string for this Silly instance's name
     * @param stringtwo a string for this Silly instance's name
     */

    public Silly(String stringone, String stringtwo) {this.name = stringone + stringtwo; }
